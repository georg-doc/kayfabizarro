...
Die Datei ist die Datengrundlage für die begehbare Graveyard-Zone (Camp-Hub, FrizzleBob als Friedhofsführer; Slice 1 unter Dropbox `/CLAUDE/KFB VoxelWorld/Graveyard_Slice1/`). Sie ist aber vor allem die Pflichtlektüre für jeden neuen Chat: **erst die Reißleinen lesen, dann arbeiten.**
...
v1.6.0 führt Slice1 und die 6 fehlenden Camp-Hub-Gräber zusammen (keine Duplikate, nach `id`) und ergänzt 16 neue Gräber vom 24.09.2026. **Ab jetzt ist diese GitHub-Datei die einzige Fassung**; die Dropbox-Kopien sind Geschichte.
