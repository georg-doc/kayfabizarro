...
export function buildCard({ THREE, root, unit = 1, art = null, log = () => {} }) {
  ...
  if (art) {
    ...
    /* Das Blatt ist hochkant (447 × 800 im Briefing), die Karte liegt quer — das Motiv wird um 90°
       gedreht aufgelegt, sonst steht der Aufdruck über Eck. */
...
export function exportCardRider({ measure, actor, pose, basePose, basePoseMatches, look, sources }) {
  const m = measure || {};
  return {
    $schema: SCHEMA,
