# HOUSEKEEPING — living, Stand 28.08.2026 (nach SpinballCast V3-S13, Studio V8-A, DC Squeeze SQ-3)
...
| `KFB Pet Studio v8.dc.html` | **AKTIV** | eine Vertragsquelle, `pet.ground`, Wächter |
| `KFB Pet Studio v7.dc.html` | **FROZEN** | Fork-Basis von v8, Vergleichsmaßstab |
