...
GitHub review corrected two stale exporter assumptions:
- `kfb-pinball-sfx.json` already exists in the central repo (blob `5f7b52e2666a19961f2f71e6e657424ee0008e9f`);
- `FrizzleBob_Yellow.gltf` already exists in `tools/KFB-ToolBox/kfb-rigs-embed-v3/...` (blob `e0a757ece30accabc4c61f1ad11751b15bd06974`).

Do not duplicate either asset. Existing assets remain GitHub-first.

Technical historical baseline remains the reviewed WS0 source tree under `tools/KFB-ToolBox/_inbox/WS0_2026-09-15/`; Studio v18 remains a donor, not an automatic contract rewrite.
...
Atlas site promotion: PR #48 merged at `5c85b09db6406f3be889aa783542670020e6a62a` after a green Resource Registry PR check.
...
**Georg decision · 2026-09-18:** the entire Birthday execution slice is **FAIL / OUTDATED / ARCHIVED HISTORY**. This includes Birthday Character Select, Travel/Astra Birthday execution, ToolBox Birthday consumer handoff and Birthday-specific QA/juice as active production work.

Historical files remain for provenance and donor mechanisms only. Generic reusable facts such as eye-source rules, measured actor profiles, Pet-Select provenance, generic audio assets or Makerspace/cinema ideas may be reused only after re-validation in their current owner context. Do not revive the failed Birthday slice around them.

Rejected Fable visual directions remain archived history as well.
