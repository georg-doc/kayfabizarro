...
- Corridor City artifacts are on current main via PR #86 / merge `3813d24e3db04a43117676890e48f7b6baaf6cd9`; post-merge consumer evidence refreshed at `25c2c616720e18d97028bf06fdd03d10c16b3504` without changing normalized/scene hashes.
...
- Race remains the implementation SSOT for the receiver. Do not merge old stacked City PRs over current main and do not duplicate the movement/physics owner.
...
**Current corridor status:** route discovery + fresh narrow source + deterministic corridor consumer are TESTED and on current `main` via PR #86. Main consumer regression `35415680112` and S2 export contract `35415680163` are PASS. Race receiver run `35414946641` is PASS. Canonical Cloudflare Stage proof `35416057009`, job `105824845921`, is **29/29 PASS** at `https://kayfabizarro.pages.dev/kfb-hub/stage/stunt-world/`: 9/9 runtime bytes exact, 2852 ms boot, 4/4 contacts, 6.406 m short public drive, no new recovery/run/errors. Human full-route and physical mobile acceptance remain separate.
