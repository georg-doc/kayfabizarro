...
**RESOLVED — no user upload needed.**

A real OSM / Overpass dataset has already been fetched, cached, normalized and committed to public `kayfabizarro/main`.
...
- railway ways: **665**
- water lines: **6**
- local frame: **2,279.652 × 2,115.070 m**
- S0 deterministic source/normalization gates: **PASS**
- attribution: **© OpenStreetMap contributors · ODbL 1.0**

Exact hero anchors are already curated:
...
- Museum Ludwig `node/633480736`
- Kölner Philharmonie `node/633480737`
- Rheinufertunnel `way/23559378`

The exact Dom OSM footprint is included in `CLAUDE_CONTEXT.json`.

**Do not query Overpass again for this Slice C build.** Use the cached public data.
