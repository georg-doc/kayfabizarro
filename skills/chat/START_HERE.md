...
Current intake update (2026-09-25): WB-D2 is the latest presentation shell candidate but waits behind WB2 Design/Rehome + WB-ZONE-SEAM; Resident S9/S40 is candidate-only/review-open and must be bridged into existing Resident/Music/Motion owners rather than promoted as another runtime.

Current WorldBuilder gate (2026-09-25): WB2 terrain/interaction is GEORG HUMAN PASS on PR #190 @ `ec52eb746be8c1a0e6f3f3d62857ed4b3121b284`. Next is the existing Claude Design authoring/UI refinement handoff; Smooth/Flatten remain later Web slices; no new Cloudflare/merge.
...
- `workflows/KFB_PRODUCTION_ARCHITECTURE_V3_2026-09-24/START_HERE.md` — **CURRENT CANDIDATE PRODUCTION ARCHITECTURE** on Draft PR #204; 13 strands / 82 jobs / 39 READY / 43 HOLD. Latest additive Resident route: `RESIDENT_DISCO_01_2026-09-24.md`.
...
- `../session_ZIP_v1.md` — **CURRENT CLAUDE DESIGN SESSION CUT EXPORT**: `/session-zip` creates the full current Session Cut/ZIP without a second veto; includes Handover, active Changelog, Source/Donor locks, tests/evidence and NEXT_CHAT. The GitHub entry is a short fallback; mirror the full `claude/session-zip-SKILL.md` body into GitHub when available for complete GitHub-only recovery.
