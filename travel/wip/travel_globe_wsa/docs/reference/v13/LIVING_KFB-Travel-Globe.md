...
```
Zuletzt passiert   10.9. · **Der Standalone wurde zum ersten Mal geöffnet — und hatte ein Loch.**
                   `rift.png` (die einzige tinyskies-Datei ohne kanonisches Repo-Gegenstück) wurde
                   nie eingebettet und relativ geladen: Portale seit dem 3.9. ohne Textur, still.
                   Jetzt als data-URL im Bündel. 87/87 Module, ok, Portal im Bild.
                   Am Code von v13 wurde NICHTS geändert.
NACHTRAG zu unten  Der Eintrag vom 30.8. bleibt gültig.
```
