...
All current `/world/` authoring surfaces use explicit `poc-local` coordinates. They are **not** Travel terrain and do not claim spherical/world anchoring.
...
Current productive Ground evidence includes persistent in-browser scale/facing calibration and the established W/S move, A/D turn, Q/E strafe mapping. Latest reported static validation is 25/25 tests plus build/verify PASS; Georg's human browser acceptance remains pending.
