...
import { malRueckseite, beiRueckseite, rueckseiteBereit } from './card-backside.js';   // v24: der Platzhalter JEDER Karte

const PAPER = '#efe6d0', CREAM = '#f7f0dd';

// Zonen-Platzhalter: die erste Sprosse, 128 px, für die Karten in der Ferne.
// v24 · 5.9. · Auch hier stand Schrift: Zonenfarbe plus eine große halbtransparente Kapitelnummer.
// Der alte Kommentar hatte den richtigen Gedanken („aus der Distanz ist eine Zone ohnehin ihre
// FARBE, nicht ihre Schrift") und trotzdem eine Nummer gemalt. Konsequent ist die Rückseite:
// bei 128 px liest sie als dunkles Blatt — und das ist genau, was eine nicht aufgedeckte Karte in
// der Ferne sein soll. Die Zonenfarbe bleibt als Grund, bis das Bild da ist.
