import {matchBellyZone,applyGunPalette,stepGunGlow} from '../combat-arena-v4/gun-look.v4a.js';
/**
...
export const SPEC = {
  ...
  yellowFiles: { plain: './assets/models/FrizzleBob_Yellow.gltf', gun: './assets/models/FrizzleBob_Yellow_Gun.gltf' },
...
export default class FrizzleBob {
  ...
  async _loadVariant(variant) {
    ...
    if (!gltf) {
      ...
      try { gltf = await this.loader.loadAsync(new URL(local, document.baseURI).href); gltf.userData = { source: 'yellow-asset', url: local }; }
