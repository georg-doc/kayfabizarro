...
function markerReport(clip){
  ...
  return{clip:clip.name,duration:+clip.duration.toFixed(4),releaseTimes:fire.times,releaseHow:fire.how,recoveryStart:recovery,recoveryMethod:'first post-release local minimum of measured right slot/hand angular velocity',rotationTrack:vel.track};
}
