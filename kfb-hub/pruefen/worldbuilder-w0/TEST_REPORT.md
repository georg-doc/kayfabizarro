...
- URL: `https://kayfabizarro.pages.dev/kfb-hub/pruefen/worldbuilder-w0/`
- Publication commit: `cloudflare-live@c2c3c2a679cbc5f28b5a0bbe93878180ca52df51`
- Fresh public browser run: 10/10 world gates PASS, route run PASS, door run PASS, 0 page errors.
- Remaining fresh-run warning: Three.js deprecation for `PCFSoftShadowMap`.
