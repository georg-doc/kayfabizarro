...
export async function installBoxStop(port,environment){
  ...
  document.body.insertAdjacentHTML('beforeend',`
    ...
    <section id="radioMorePanel" hidden><b>KFB Radio</b><p class="subtle">Repository jukebox · ten tracks</p><select id="radioTrack" aria-label="Music track"></select><p id="radioState" class="subtle radioState">Ready · press Play</p><p class="subtle">Adaptive A1 soundscape: awaiting original source. No replacement synthesis is playing.</p><label class="subtle"><input id="reducedMotion" type="checkbox"> Steady instruments</label></section>
