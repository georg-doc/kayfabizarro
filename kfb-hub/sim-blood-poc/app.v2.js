(() => {
  ...
  const SCOPE_REFERENCE_PX = 760;
  function scopeViewportScale() {
    const w = canvas.clientWidth || scope.clientWidth || SCOPE_REFERENCE_PX;
    return clamp(w / SCOPE_REFERENCE_PX, .42, 1);
  }
  function zoomScale() {
    return (.1466666667 + S.mag * .0103333333) * scopeViewportScale();
  }
