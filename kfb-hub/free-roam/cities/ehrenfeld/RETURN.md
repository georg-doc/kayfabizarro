# KFB Free Roam · Köln-Ehrenfeld · RETURN

**Permanent Cloudflare entry:** https://kayfabizarro.pages.dev/kfb-hub/free-roam/cities/ehrenfeld/  
**Current S1 viewer:** https://kayfabizarro.pages.dev/tools/osm-city-lab/?city=ehrenfeld-v0  
**Dataset:** `tools/osm-city-lab/data/ehrenfeld-v0/`
...
2. `tools/osm-city-lab/data/ehrenfeld-v0/SOURCE_SPEC.json`
3. `tools/osm-city-lab/data/ehrenfeld-v0/PROVENANCE.json`
4. `tools/osm-city-lab/evidence/ehrenfeld-v0-s0-report.json`
5. `tools/osm-city-lab/docs/CONSUMER_CONTRACT.md`
6. `skills/chat/workflows/ASTRA_INTEGRATION_01_2026-09-18/WALK_DRIVE_COMBAT/CONTRACT_PROPOSAL.md`

## Tested S0 evidence

- bounds: **659.24 × 595.56 m**
- roads: **372**
- buildings: **1808**
- landuse: **22**
- source elements: **11874**
- gates: **deterministic reload · OSM IDs · fixed bbox PASS**
