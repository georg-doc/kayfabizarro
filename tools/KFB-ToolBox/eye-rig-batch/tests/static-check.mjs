...
const files=['index.html','styles.css','app.js','lib/kaykit-eye-adapter.v1.js','lib/source-face-cleanup.v1.js','lib/medium-source-eye-cleanup.v1.js','data/gothgirl.seed.json','data/rig-medium-default.v0.json','data/rig-medium-actors.v0.json','docs/SOURCE_AUDIT.md','docs/SOURCE_COMPONENT_IDENTITY_2026-09-19.md','docs/source-components-0-11.html','docs/QA_EYE_CALIBRATION_LOOP_2026-09-19.md','docs/BATCH_FEATURE_BACKLOG_2026-09-19.md'];
...
const app=fs.readFileSync(path.join(root,'app.js'),'utf8'); const html=fs.readFileSync(path.join(root,'index.html'),'utf8'); const cleanup=fs.readFileSync(path.join(root,'lib/source-face-cleanup.v1.js'),'utf8'); const mediumCleanup=fs.readFileSync(path.join(root,'lib/medium-source-eye-cleanup.v1.js'),'utf8'); const adapter=fs.readFileSync(path.join(root,'lib/kaykit-eye-adapter.v1.js'),'utf8'); const seed=JSON.parse(fs.readFileSync(path.join(root,'data/gothgirl.seed.json'),'utf8')); const medium=JSON.parse(fs.readFileSync(path.join(root,'data/rig-medium-default.v0.json'),'utf8')); const actors=JSON.parse(fs.readFileSync(path.join(root,'data/rig-medium-actors.v0.json'),'utf8')); const identity=fs.readFileSync(path.join(root,'docs/SOURCE_COMPONENT_IDENTITY_2026-09-19.md'),'utf8'); const componentHtml=fs.readFileSync(path.join(root,'docs/source-components-0-11.html'),'utf8'); const qa=fs.readFileSync(path.join(root,'docs/QA_EYE_CALIBRATION_LOOP_2026-09-19.md'),'utf8'); const backlog=fs.readFileSync(path.join(root,'docs/BATCH_FEATURE_BACKLOG_2026-09-19.md'),'utf8');
...
check('batch-import-export-v02',app.includes('kfb.eye-profile-batch/0.2-candidate')&&app.includes('classDefault:clone(state.mediumSeed.authoringDefault)')&&app.includes('selectedActorIds:ids')&&app.includes('profiles'));
