...
/* ⚠ Georg 13.09., am Bild: »Kayfa« in Tusche (#141210) auf der schwarzen Lederjacke ist kaum lesbar
   — Bizarros Schrift steht in Papier (#f6efd9) auf Rot und liest sich klar. Vorgabe jetzt: dieselbe
   Farbe für beide Zeilen. »Tusche« bleibt als Knopf wählbar, ist aber nicht mehr die Vorgabe. */
export const DEFAULTS = { on: true, ink: '#f6efd9', plate: '#b3311f', paper: '#f6efd9', tilt: -8 };
