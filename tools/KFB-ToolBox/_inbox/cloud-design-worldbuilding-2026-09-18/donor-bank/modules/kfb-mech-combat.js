...
export const SFX_PRESETS = {
  ...
  /* v3 · Oberflaechen-Toene. Der Impact gehoert der OBERFLAECHE, nicht der Waffe:
     derselbe Schuss klingt auf Wasser, Knochen und Schild verschieden. */
  splash:   [['noise', 0.34, 1400, 260, 1.2, 0.26], ['tone', 0.2, 240, 620, 'sine', 0.08]],
  splat:    [['tone', 0.13, 420, 90, 'sine', 0.2], ['noise', 0.1, 900, 180, 2.2, 0.14]],
  snap:     [['tone', 0.05, 3200, 800, 'square', 0.1], ['noise', 0.07, 7000, 1600, 8, 0.13]],
  ping:     [['tone', 0.16, 2400, 1500, 'triangle', 0.1]]
};

/* v3 · VORRANG STATT LAUTSTAERKE. Ohne Regel wird Dauerfeuer zu Rauschen, egal wie gut die
   einzelnen Klaenge sind. Der Wirt soll das in seinem Mixer nachbauen, nicht der Slice:
   hoechstens drei Cues in 90 ms, und ein dominanter Treffer verdraengt schwaechere. */
export const CUE_VORRANG = { fenster: 0.09, maxGleichzeitig: 3, regel: 'schwaechster weicht, gleich starke fallen aus' };
