...
## Last sync
date: 2026-09-24T19:44:15Z

### Updated in this project (WB-D1 · Hbf + Landmark-KFB-Pass, 2026-09-24)
- Hbf über `lab-v9/cologne-landmarks.v1.js buildGeniusLoci` (nur hauptbahnhof), Achse aus `CLAUDE_CONTEXT.hbfRailways` (PCA, −55,1°), OSM-Teile unter der Halle nach Validierung ausgeblendet.
- Dom + Hbf in KFB_WONKY_90S_CLAY_V1 + Elastic-Clay-Körper, ohne Bodenplatten; Socket schraffiert; Dach-Artefakte (Orientierung + konkave Dächer) behoben; Wasser-Presets in den App-Einstellungen.

## Last sync (WB-D1 Georg-Korrektur)
date: 2026-09-24T17:56:35Z

### Updated in this project (WB-D1 Cologne Shell · Georg-Korrektur, 2026-09-24)
- Gebäude jetzt Elastic Grotesque Clay V2 (`elastic-grotesque-clay.mjs` @0c59e92d, Palette KFB_WONKY_90S_CLAY_V1 aus viewer.mjs); Fixture um OSM roof/materialClass/minHeightM ergänzt.
- Straßen als eine Bodenkarte (Canvas, round join/cap) statt Bänder + Endscheiben; Wasser = Card-Zone-v2-Fluid (`KFB StoryMap v1/kfb-fluid-v2/card-zone-v2-fluid-source.js`, dudv+map geladen); Tusche standardmäßig aus; Buttons deckend.

## Last sync (WB-DESIGN-PARALLEL-01 first pass)
date: 2026-09-24T17:40:00Z

### Updated in this project (WB-DESIGN-PARALLEL-01 · Cologne World Shell, 2026-09-24)
- Neu: `KFB WB-D1 · Cologne World Shell.dc.html` + `wd1-boot.js` · `wd1-seam.js` · `wd1-city.js` · `wd1-landmark.js` · `fixtures/cologne-dom-crop-v0.json` (eingefrorener Crop aus dom-zentrum-v0 @2ff8b350). Ansichten 01 FIXTURE · 02 LANDMARK · 03 SHELL.
- Donors @c049cae386e1: Option-C `cologne-world` (buildDom/buildRhine), `cologne-route`, `option-c-style`; `osm-city-lab` cartoon-city + kfb-city-v0; edit-layer @8922d4b1; WB-W0 region/ink unverändert.
- „KFB Production Architecture v3“ im Repo nicht gefunden — Brief-Text benutzt. Rückgabe: `returns/WB-DESIGN-PARALLEL-01_2026-09-24/`.
