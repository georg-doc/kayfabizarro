...
/* Eine Atlas-Textur, nicht zwölf — dieselbe Faltung wie in lib/kit-lab.js.
   Jede gltf verweist relativ auf ihre Textur, also löst jeder Unterordner eine eigene URL für
   dieselbe Datei auf. Schlüssel ist Pack-Ordner + Dateiname, nicht der Dateiname allein. */
export const textureAliases = new Map();
export const textureFolds = { seen: 0, unique: 0 };
const texManager = new THREE.LoadingManager();
texManager.setURLModifier((url) => {
...
const loader = new GLTFLoader(texManager);
const cache = new Map();
