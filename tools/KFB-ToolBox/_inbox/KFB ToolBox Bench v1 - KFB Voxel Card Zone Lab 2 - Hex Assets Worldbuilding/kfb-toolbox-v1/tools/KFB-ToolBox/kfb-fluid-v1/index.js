...
export { createFluidMaterial, buildFluidGeometry, FLUIDS, FLUID_VERT, FLUID_FRAG } from './kfb-fluid-shader.js';
...
export function mountFluidSystem(cfg) {
  ...
  const gutter = createGutter({
    THREE: cfg.THREE, scene: cfg.scene, field, terrain: cfg.terrain,
