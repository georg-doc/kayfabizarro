...
const water = mountFluidSystem({
  THREE, scene, terrain,            // terrain = voxel-terrain v10 (optional)
...
Stufen 0.60, Absenkung 0.0, Seed 42):
...
Optional, beide aus dem KFB-Repo. **Nicht mitkopieren** — SourceRef mit Commit-Pin (KFB-Regel 1):
...
Ohne sie läuft der rein prozedurale Pfad.

## Status

`TESTED RESULT` — mountet und läuft auf `KFB ToolBox Bench.dc.html`, Zahlen oben gemessen.
