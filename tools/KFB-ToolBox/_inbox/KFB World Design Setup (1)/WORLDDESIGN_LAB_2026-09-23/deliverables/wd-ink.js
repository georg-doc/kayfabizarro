...
export function createInk({ renderer, scene, camera }) {
  ...
  for (const k of ['strength', 'thin', 'thick', 'lightLo', 'lightHi', 'depthEdge', 'normalEdge', 'grain', 'wobble', 'wobbleSpeed', 'gap', 'surf']) {
  ...
  const Shader = {
    ...
    fragmentShader: [
      ...
      'uniform float uStrength, uThin, uThick, uLightLo, uLightHi, uDepthEdge, uNormalEdge, uNear, uFar, uTime, uGrain, uWobble, uWobbleSpeed, uGap, uSurf;',
      'varying vec2 vUv;',
