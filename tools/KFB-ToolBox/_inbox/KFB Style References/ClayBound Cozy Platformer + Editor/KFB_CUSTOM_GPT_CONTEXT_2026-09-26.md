...
Source snapshot main HEAD: `8ed9acd163581019006b2cc2b316ea51c211a027`
...
Owns the current ClayBound / handmade-material production exploration and receives accepted production assets. It does **not** become a new game runtime owner.
...
### Asset Librarian
Receiving/discovery owner for approved assets when they are explicitly promoted. Do not create a parallel asset registry.
...
### Grayscale / data maps
Do not call a grayscale-looking image a validated height, roughness or normal map by appearance alone. Where practical inspect channel neutrality, histogram/range and intended value behavior.

### Cutout / decal sheets
Require clean isolated elements, real alpha when claimed, no checkerboard printed into RGB, and extraction/readability appropriate to the Blender use case.
...
This pack is a snapshot of the verified KFB state around main `8ed9acd163581019006b2cc2b316ea51c211a027`.
