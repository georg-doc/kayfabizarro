> **CURRENT OVERRIDE · 2026-09-26 · TOOLBOX r2 STAGE REVIEW FROZEN FAIL:** Review consumer PR #220 / `chatgpt-web/toolbox-r2-stage-review-2026-09-26` is preserved at implementation head `cab463b6a4b9bfd9cc365694ff462b39bc493b8e` after two Chromium attempts, each **28/29 PASS**. Pass 1 failed movement sampling (0.000 m); one bounded repair starts on semantic Walk; Pass 2 proves movement at 0.299 m but fails deterministic transition-count timing (1 observed, ≥2 expected). Screenshots additionally show the real `FB_TEMPLATE_LOOK_v5.glb` framed too tightly, cropping the head top / EarRig-v5 ears, especially on mobile. **STOP: no third repair in this slice, no Cloudflare publish, no Hub test link, no merge.** Read [the failure-recovery entrypoint](_handover/TOOLBOX_PRODUCTION_01_R2_STAGE_REVIEW_2026-09-26/START_HERE.md). PR #185 r2 owner rehome at `5dcf34bc...` remains technically green and is not rolled back. Exactly one next gate: fresh review-surface recovery for event-driven transition proof + complete actor/ear framing.

> **CURRENT OVERRIDE · 2026-09-26 · TOOLBOX r2 OWNER REHOME CI PASS:** Claude Session Cut r2 has been intaked and its owner deltas are now re-homed on PR #185. Tested head `5dcf34bcdf9d87445e927c98f60d41adae72f00e`: PoseRig owner + Stage mirror synchronized, canonical `stage-first/src/lab/locomotion-profiles.v1.js` added, measured FrizzleBob Rig_Medium consumer fixture added. Actions run `36197260540` SUCCESS: **31/31 coherent static · 34/34 AN-PROFILE static · 20/20 coherent Chromium · 25/25 AN-PROFILE Chromium · 13/13 plain-review Chromium**. This is receiving-owner technical PASS, not Georg r2 visual acceptance. Current next gate: build/publish one unobstructed ToolBox r2 Stage review from these owners; do not return to the rejected AN-PROFILE transport.
