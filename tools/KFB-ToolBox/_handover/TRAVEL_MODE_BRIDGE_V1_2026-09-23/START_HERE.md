...
TMB-1E final:
- HUMAN_ACCEPTED by Georg after direct Chat review;
- accepted Travel commit `603f2a9e8fb2c8efd1008ed67607cf7a712de0bd`;
- visible trio: **ActionFigure / Rig_Medium + Orc Brute / Rig_Large + Warband Orc B / Rig_Legacy**;
- accepted Capacity relation uses the **2.0× rider-size candidate**;
- exact CardCarrier geometry/thickness remains unchanged;
- native rig-class proportions remain preserved;
- Chat attachment texture adapter is HUMAN-PASSED for the modern textured sources;
