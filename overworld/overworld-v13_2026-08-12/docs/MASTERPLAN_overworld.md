...
> ⚠ **Vermerk 2026-08-12 (WS0, mit Georgs Freigabe): dieser Plan liegt hinter dem Code.** Stand
> unten ist 9.8./v10; gebaut ist v13. Neun Entscheidungen aus v11/v12 fehlen hier — der einsetzbare
> Patch steht in `docs/overworld-v13/ABGLEICH_briefings_2026-08-12.md` §3, der Datei-Diff in
> `docs/overworld-v13/HANDOVER_WS1_2026-08-12.md`. **Bis der Patch eingearbeitet ist, ist dieses
> Blatt keine gültige Quelle für v11+.** Eigentum bleibt WS1; eingearbeitet wird dort.
...
| **Wegelagerer-Slice vor den Wellen:** Mob-Zonen abseits der Wege mit Trainings-Gegnern auf niedrigem Level. Wer kämpfen lernen will, braucht dafür keine Card Zone und kein Tutorial | `ENTSCHIEDEN` 9.8. |
...
| **Kartenrückseiten-Varianten:** Seite 15 des Anti-Rules-Decks sind vier Rückseiten mit »BLÖDSINN!« → Asset-Satz für KFB **und** MED, gewählt nach Kontext/Seed/Zufall | `ENTSCHIEDEN` 9.8. — löst die eine feste Rückseite (1872×1045) ab |
...
6. **Wegelagerer-Zonen** — Trainings-Gegner abseits der Wege, Kämpfen lernen ohne Card Zone.
7. **Signatur-Shader je Terrain-Typ** — `docs/SSOT_Waber_Shader.md`, Faltung in `OW_SHADE`.
6. **WS0-HUD einbauen** — Reihenfolge in `docs/REVIEW_WS0_hud-v9b.md` §5.
7. **Content-Surface (MediaSurface)** — erst wenn Tutorial-Runde und Reveal stehen.
8. **Küstenlinien** — als Federstriche, in der Kachel gebacken.
