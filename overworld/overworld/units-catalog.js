...
const enemies={
  ...
  turtle:{name:'Turtle',role:'melee',biome:'cave',
  ...
  skull:{name:'Skull',role:'melee',biome:'dungeon',
  ...
  thief:{name:'Thief',role:'melee',biome:'dungeon',
  ...
  bomb_fish:{name:'Bomb Fish',role:'ranged',biome:'water',avatar:PAV+e('Bomb Fish.png'),
    ...
    projectile:en('Pirate Fish/Bomb','Bomb_Spinning.png')},
  harpoon_shark:{name:'Harpoon Shark',role:'ranged',biome:'water',avatar:PAV+e('Harpoon Shark.png'),
    ...
    projectile:en('Pirate Fish/Harpoon Shark','Harpoon.png')},
  ...
  minotaur:{name:'Minotaur',role:'boss',biome:'dungeon',
  ...
  troll:{name:'Troll',role:'boss',biome:'wilds',
...
// Nummerierte Avatare (01, 06–16) — Zuordnung ungemessen, erst am Bild klären, nicht raten.
const avatarsUnmapped=['01','06','07','08','09','10','11','12','13','14','15','16']
  .map(n=>PAV+e(`Enemy Avatars_${n}.png`));
...
const KNIGHT_CLASSES={warrior:'Warrior',archer:'Archer',pawn:'Pawn'};
...
window.OW_UNITS={playable,enemies,props,critters,tempers,avatarsUnmapped,
