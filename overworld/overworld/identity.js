...
const TITEL=[
  {id:'newbie',  name:'Newbie',              woher:'Anfang',
   hat:()=>true},
  {id:'pigsbane',name:'Scourge of Swine',    woher:'drei Schweine ohne Grund',
   hat:s=>(s.hunt|0)>=3},
  {id:'evidence',name:'Keeper of Evidence',  woher:'drei Karten geborgen',
   hat:s=>(s.collected|0)>=3},
  {id:'unwelcome',name:'The Unwelcome',      woher:'irgendwo tief unten im Ruf',
   hat:s=>Math.min(...Object.values(s.rep||{0:0}))<=-8},
  {id:'loud',    name:'Professionally Loud', woher:'zehn Schreie',
   hat:s=>(s.shouts|0)>=10},
  /* **Leichenfledderer bleibt deutsch** (entschieden 10.8., ChatGPTs Argument angenommen).
     Er ist kein deutsches Wort in englischem Fließtext, sondern ein **Eigenname** — dieselbe
     Klasse wie BLÖDSINN!, Kayfabulation und King Kayfabian. Übersetzt (»Grave Robber«) verlöre er
     genau das, was ihn zum Titel macht: dass ihn niemand aussprechen kann und trotzdem jeder weiß,
     was gemeint ist. Steht damit auf der Eigennamen-Liste. */
  {id:'fledderer',name:'Leichenfledderer',    woher:'die erste Karte aus einem geräumten Grab',
