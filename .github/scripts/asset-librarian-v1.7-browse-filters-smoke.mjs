...
async function run(){
  ...
  try{
    ...
    assert(typeMulti.summary.includes('Character')&&typeMulti.summary.includes('Nature'),`type multiselect summary missing: ${typeMulti.summary}`);result.checks.typeMultiselect=typeMulti;
